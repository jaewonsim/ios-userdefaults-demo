...
class PreferencesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // TODO: Create a UISegmentedControl for setting distance unit preferences
        ...
        // TODO: Create a UISegmentedControl for setting emoji visibility preferences
        emojiControl = UISegmentedControl()
        emojiControl.insertSegment(withTitle: "Hide emojis", at: 0, animated: true)
        emojiControl.insertSegment(withTitle: "Show emojis", at: 1, animated: true)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // TODO: Set the UISegmentedControl for distance to the current preferences pulled from UserDefaults
        ...
        // TODO: Set the UISegmentedControl for temperature to the current preferences pulled from UserDefaults
        ...
        // TODO: Set the UISegmentedControl for emoji visibility to the current preferences pulled from UserDefaults
    ...
    @objc func savePreferences() {
        ...
        // TODO: Since the enum `DistanceUnit` is a `CaseIterable`, we can use the `allCases` property to obtain an array with all of the cases listed in the order of case declaration. Then, we can access
        ...
        // TODO: Here, no `enum` conversion is necessary because the UserDefaults entry for emoji visibility is a bool -- which can be natively handled. Hence, a simple true/false if/else is already safe.
